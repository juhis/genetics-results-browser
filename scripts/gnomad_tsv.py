# re-vep-annotate gnomAD - newer gencode versions contain more noncoding genes that can overshadow good coding annotations
# running gencode v29 (vep 95) gives more coding genes than v35 (vep 101)
# https://gnomad.broadinstitute.org/help/vep
# would be best to use a new gencode version but filtering its transcripts to coding
#
# adapted from
...
export(
    table,
    "gs://gnomad3/genomes_3.0/gnomad.genomes.v3.1.2.sites.all.vep95.gencode29.tsv.bgz",
)
